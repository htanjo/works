        ...
        description={
          <>
            <p>
              ...
              Webブラウザ上で動作する3Dコンテンツで、上下スクロールを主体とした簡単な操作性が特徴。
            </p>
            <p>
              現在、技術デモ版を公開している。
              PCだけでなくモバイルからもアクセス可能。
              環境に合わせて最適なレンダリングを行う。
            </p>
            <p>
              既存アセットは極力使わず、モデリングからマテリアル作成、プログラミングまで、スクラッチで制作した。
      ...
      <Section
        ...
        description={
          <>
            ...
            <p>
              スクリーンショットでは伝わりにくいが、実際にプレイしてみるとその差は歴然。
              ゲーム本来の良さを残しながら、さらに表現力豊かな色彩をもたらすとして、海外のMODコミュニティNexus
              Modsで高く評価された。
            </p>
            <p>
              リリース時にはHot Mods
        ...
        description={
          <>
            <p>
              ...
              絵画的でやや非現実感のあるトゥサンの風景を、天候設定を書き換えることでより自然なものへと変更する。
            </p>
            <p>
              しかし、ゲーム本体の最新パッチにより互換性がなくなり、残念ながらこのMODは一般公開しなかった。
            </p>
          </>
        }
        images={[
      ...
      <Section
        ...
        description={
          <>
            ...
            <p>
              普通の動画と違い、マウスやデバイスの動きに合わせて視点を動かすことができる。
              またVRモードもサポートし、対応スマホやVRヘッドセットでアクセスすると、実寸大のロボット変形が間近で楽しめる。
            </p>
            <p>「The 9th Floor」のコードを流用し、2週間ほどで制作した。</p>
            <div>
              作品ページ
              <br />
              <a
      ...
      <Section
        ...
        info={
          <>
            2022年～現在
            <br />
            Blender / ZBrush / Corel Painter / Photoshop
          </>
        }
        description={
          <>
            <p>
              3Dスカルプトによるモデリングの習作。
              既存のアセットは一切使わず、美術解剖学を参考にゼロからモデリングした。
            </p>
            <p>
      ...
      <Section
        ...
        description={
          <>
            ...
            <p>
              また同時に、Photoshopで複数のカラーバリエーションを作成し、配色の参考とした。
              左の画像が実際に採用となったもの。
            </p>
          </>
        }
      ...
      <Section
        ...
        description={
          <>
            ...
            <p>
              白組所属だったため白虎をモチーフとした。
              全8組の中から来場者投票によって1位が選ばれる「アーチ賞」を受賞した。
            </p>
          </>
        }
        images={[
      ...
      <Section
        ...
        description={
          <>
            ...
            <p>
              実際のゲーム画面を参考に全塗装し、パーツ同士の合わせ目消しやデカールの段差消しまで丁寧に行った。
              いずれウェザリング塗装を施す予定で、あえてマット調の仕上げとした。
            </p>
          </>
        }
        images={[
